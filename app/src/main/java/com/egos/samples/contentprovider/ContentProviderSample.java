...
/**
 * 数据被多个进程共享 Created by Egos on 2016/12/18.
 */
public class ContentProviderSample extends ContentProvider {
    ...
    public static final String AUTHORITY = "com.egos.samples";
    ...
    public String getType(Uri uri) {
        ...
        switch (sUriMatcher.match(uri)) {
            case BOOK_URI_CODE:
                return "vnd.android.cursor.item/egos.book";
            case USER_URI_CODE:
                return "vnd.android.cursor.item/egos.user";
            default:
                throw new IllegalArgumentException("Unsupported Uri = " + uri);
        }
    }
